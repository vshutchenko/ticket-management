...
namespace TicketManagement.UnitTests.ServicesUnitTests
{
    ...
    internal class LayoutServiceTest
    {
        ...
        public void SetUp()
        {
            ...
            LayoutValidator layoutValidator = new LayoutValidator(_layoutRepositoryMock.Object);
        ...
        {
            // Arrange
            LayoutModel layoutToCreate = new LayoutModel { Id = 1, Description = "New Layout", VenueId = 1, };
            Layout mappedLayout = new Layout { Id = 1, Description = "New Layout", VenueId = 1, };
        ...
        public async Task Create_LayoutWithSameDescriptionExists_ThrowsValidationException()
        {
            ...
            LayoutModel layoutToCreate = new LayoutModel { Description = "Layout 1", VenueId = 1, };
            Layout mappedLayout = new Layout { Description = "Layout 1", VenueId = 1, };

            _mapperMock.Setup(m => m.Map<Layout>(layoutToCreate)).Returns(mappedLayout);

            // Act
            System.Func<Task<int>> creatingLayout = _layoutService.Invoking(s => s.CreateAsync(layoutToCreate));
        ...
        public async Task Create_NullLayout_ThrowsValidationException()
        {
            ...
            // Act
            System.Func<Task<int>> creatingLayout = _layoutService.Invoking(s => s.CreateAsync(nullLayout));
        ...
        {
            // Arrange
            Layout layout = new Layout { Id = 1, Description = "Layout 1", VenueId = 1, };
        ...
        public async Task Delete_LayoutNotFound_ThrowsValidationException()
        {
            ...
            // Act
            System.Func<Task> deletingLayout = _layoutService.Invoking(s => s.DeleteAsync(notExistingId));
        ...
        public async Task Update_ValidLayout_UpdatesLayout()
        {
            ...
            Layout layout = new Layout { Id = 1, Description = "Layout 1", VenueId = 1, };
            List<Layout> layouts = new List<Layout> { layout };

            _layoutRepositoryMock.Setup(x => x.GetByIdAsync(id)).ReturnsAsync(layout);
            _layoutRepositoryMock.Setup(x => x.GetAll()).Returns(layouts.AsQueryable());

            LayoutModel layoutToUpdate = new LayoutModel { Id = 1, Description = "New Layout", VenueId = 1, };
            Layout mappedLayout = new Layout { Id = 1, Description = "New Layout", VenueId = 1, };
        ...
        public async Task Update_LayoutNotFound_ThrowsValidationException()
        {
            ...
            // Act
            System.Func<Task> updatingEvent = _layoutService.Invoking(s => s.UpdateAsync(layoutToUpdate));
        ...
        public async Task Update_LayoutWithSameDescriptionExists_ThrowsValidationException()
        {
            ...
            LayoutModel layoutToUpdate = new LayoutModel { Id = 2, Description = "Layout 1", VenueId = 1, };
            Layout mappedLayout = new Layout { Id = 2, Description = "Layout 1", VenueId = 1, };

            _mapperMock.Setup(m => m.Map<Layout>(layoutToUpdate)).Returns(mappedLayout);

            // Act
            System.Func<Task> updatingLayout = _layoutService.Invoking(s => s.UpdateAsync(layoutToUpdate));
        ...
        public async Task Update_NullLayout_ThrowsValidationException()
        {
            ...
            // Act
            System.Func<Task> updatingLayout = _layoutService.Invoking(s => s.UpdateAsync(nullLayout));
        ...
        public void GetAll_LayoutListNotEmpty_ReturnsLayoutList()
        {
            ...
            List<LayoutModel> mappedLayouts = new List<LayoutModel>
            {
            ...
            // Act
            IEnumerable<LayoutModel> actualLayouts = _layoutService.GetAll();
        ...
        public async Task GetById_LayoutExists_ReturnsLayout()
        {
            ...
            Layout layout = new Layout { Id = 1, Description = "Layout 1", VenueId = 1, };
            LayoutModel mappedLayout = new LayoutModel { Id = 1, Description = "Layout 1", VenueId = 1, };
            ...
            // Act
            LayoutModel actualLayout = await _layoutService.GetByIdAsync(id);
        ...
        public async Task GetById_LayoutNotFound_ThrowsValidationException()
        {
            ...
            // Act
            System.Func<Task<LayoutModel>> gettingById = _layoutService.Invoking(s => s.GetByIdAsync(id));
